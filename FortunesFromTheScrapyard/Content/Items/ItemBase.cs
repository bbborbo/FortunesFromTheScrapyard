...
namespace FortunesFromTheScrapyard.Items
{
    ...
    public abstract class ItemBase : SharedBase
    {
        ...
        public static GameObject LoadDropPrefab(string prefabName = "")
        {
            ...
            if (FortunesPlugin.mainAssetBundle && prefabName != "")
            {
                prefab = FortunesPlugin.mainAssetBundle.LoadAsset<GameObject>($"Assets/Models/DropPrefabs/Item/{prefabName}.prefab");
            }
        ...
        public static GameObject LoadDisplayPrefab(string prefabName = "")
        {
            ...
            if(FortunesPlugin.mainAssetBundle && prefabName != "")
            {
                prefab = FortunesPlugin.mainAssetBundle.LoadAsset<GameObject>($"Assets/Models/DisplayPrefabs/Item/{prefabName}.prefab"); ;
            }
            return prefab;
        }
        ...
        {
            Sprite icon = null;
            if (FortunesPlugin.mainAssetBundle && spriteName != "")
            {
                icon = FortunesPlugin.mainAssetBundle.LoadAsset<Sprite>($"Assets/Textures/Icons/Item/{spriteName}.png");
            }
