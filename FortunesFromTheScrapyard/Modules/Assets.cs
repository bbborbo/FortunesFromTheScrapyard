...
using System.Linq;
using FortunesFromTheScrapyard.Characters;
...
namespace FortunesFromTheScrapyard.Modules
{
    ...
    internal static class Assets
    {
        ...
        internal static AssetBundle LoadAssetBundle(string bundleName)
        {
            ...
            assetBundle = AssetBundle.LoadFromFile(Path.Combine(Path.GetDirectoryName(FortunesPlugin.instance.Info.Location), bundleName));
